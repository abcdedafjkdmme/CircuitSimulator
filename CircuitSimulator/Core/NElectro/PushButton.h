...
private:
    ...
    const std::string PushedDownImage = "Core/NElectro/Resources/PushButtonPushed.png";
    const std::string UnpushedImage = "Core/NElectro/Resources/PushButtonUnpushed.png";
